...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-app">
      ...
      <main className="relative z-10 flex flex-col items-center px-6 pb-32 pt-20 md:pt-28">

        {/* ── HERO ── */}
        <section className="flex flex-col items-center text-center">
          <div
            className="mb-4 inline-flex items-center gap-2 rounded-full border px-3 py-1 text-xs font-medium neu-sm"
            style={{ borderColor: "#C2D5EB", color: "#4A6D8C", backgroundColor: "#F4F8FF" }}
          >
            <span className="h-1.5 w-1.5 rounded-full bg-ok" />
            AI-native · Real-time · 14 commands
          </div>

          <h1
            className="mx-auto max-w-2xl text-6xl font-bold leading-[1.05] tracking-tight md:text-7xl lg:text-8xl"
            style={{ color: "#1B3652" }}
          >
            Think out loud.
          </h1>
          ...
          <div className="mt-10 flex items-center gap-4">
            <SignedOut>
              ...
              <Link href="/sign-in" className="text-sm transition-colors hover:text-ink-1" style={{ color: "#7B9AB8" }}>
                Sign in
              </Link>
            </SignedOut>
            <SignedIn>
        ...
        <section className="mx-auto mt-20 w-full max-w-3xl">
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            {[
              ...
              <div
                key={s.label}
                className="flex flex-col items-center rounded-2xl p-5 text-center neu-card bg-surface"
              >
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {[
              ...
              >
                ...
                <span
                  className="max-w-0 overflow-hidden transition-all duration-200 group-hover:max-w-[120px]"
                  style={{ color: "#A8C2D8" }}
                >
                  &nbsp;·&nbsp;{item.desc}
                </span>
        ...
        <section className="mx-auto mt-32 w-full max-w-3xl">
          <p className="mb-2 text-center text-[10px] uppercase tracking-widest" style={{ color: "#A8C2D8" }}>
            How it works
          </p>
          <h2 className="mb-12 text-center text-3xl font-bold" style={{ color: "#1B3652" }}>
          ...
          <div className="grid gap-6 text-left sm:grid-cols-3">
            {[
              ...
              <div key={f.label} className="neu-card rounded-2xl p-5 bg-surface">
                <span className="mb-3 block text-xs font-mono font-semibold" style={{ color: "#2563EB" }}>
                  {f.step}
                </span>
        ...
        <section className="mx-auto mt-32 w-full max-w-3xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div
                key={f.title}
                className="flex gap-4 rounded-2xl p-5 bg-surface neu-sm border border-line-1"
              >
        ...
        <section className="mx-auto mt-32 w-full max-w-3xl">
          ...
          <h2 className="mb-10 text-center text-3xl font-bold" style={{ color: "#1B3652" }}>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div
                key={t.name}
                className="flex flex-col gap-3 rounded-2xl p-5 bg-surface neu-card"
              >
                <p className="text-sm leading-relaxed" style={{ color: "#4A6D8C" }}>
                  &ldquo;{t.quote}&rdquo;
                </p>
        ...
        <section className="mx-auto mt-32 w-full max-w-2xl">
          ...
          <div className="space-y-3">
            {[
              {
                q: "Is it really free?",
                a: "Yes. Create an account and start using all 14 AI commands immediately, no credit card required.",
              },
              {
                q: "Which AI model powers it?",
                a: "GPT-4o mini — fast, accurate, and optimized for structured generation tasks like tables, outlines, and diagrams.",
              },
              {
                q: "Is my data private?",
                a: "Notes are stored securely in Convex and tied to your account. We do not train on your content.",
              },
              {
                q: "Can I use it offline?",
                a: "The editor is accessible offline, but AI commands and real-time sync require a connection.",
              },
              {
                q: "Does it work on mobile?",
                a: "Yes. The app is fully responsive with a dedicated mobile bottom nav and touch-friendly editor.",
              },
            ].map((faq) => (
              <details
                key={faq.q}
                className="group rounded-2xl border border-line-1 bg-surface neu-sm"
              >
                <summary
                  className="flex cursor-pointer items-center justify-between px-5 py-4 text-sm font-semibold list-none"
                  style={{ color: "#1B3652" }}
                >
                  {faq.q}
                  <span
                ...
                <p className="px-5 pb-4 text-sm leading-relaxed" style={{ color: "#7B9AB8" }}>
                  {faq.a}
                </p>
              </details>
            ))}
        ...
        <section className="mt-32 flex flex-col items-center text-center">
          <div
            className="mb-6 rounded-3xl px-10 py-10 text-center neu-card bg-surface"
            style={{ maxWidth: 480 }}
          >
            <h2 className="text-3xl font-bold" style={{ color: "#1B3652" }}>
            ...
            <div className="mt-6">
              <SignedOut>
                <Link
                  href="/sign-up"
                  className="neu-btn inline-block rounded-lg px-8 py-4 text-sm font-semibold text-white hover:opacity-90"
                  style={{ backgroundColor: "#2563EB" }}
                >
                  Create free account →
                </Link>
